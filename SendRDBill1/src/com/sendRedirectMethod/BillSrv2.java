...
public class BillSrv2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		out.print("<tr><td>Item Name:</td><td><input type=text name=name value=" +item+ "/></td></tr>");
		out.print("<tr><td>Final Bill:</td><td><input type=text name=name value=" +fbill+ "/></td></tr>");
