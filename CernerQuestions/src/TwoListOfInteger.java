...
public class TwoListOfInteger {
	static void lastAndFirstInteger(ArrayList arr1, ArrayList arr2) {
		...
		} else if (str1.compareTo(str2) > 0) {        // str1 > str2; in the case str1 is greater than str2
			System.out.println(str2+", "+str1);
		} else if (str1.compareTo(str2) < 0) {       // str1 < str2; in the case str2 is greater than str1 
	...
	public static void main(String[] args) {
		...
		ArrayList<String> arr1 = new ArrayList<String>(Arrays.asList("3","2","4","20"));
		ArrayList<String> arr2 = new ArrayList<String>(Arrays.asList("10","6","8"));
